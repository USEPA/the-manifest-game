...
const initialNodes: Array<ManifestNode> = [
    ...
    {id: '4', hidden: true, connectable: false, draggable: false, position: {x: 200, y: 300}, data: {label: 'bar'}},
    {id: '5', hidden: true, connectable: false, draggable: false, position: {x: 400, y: 300}, data: {label: 'xxx'}},
    {id: '6', hidden: true, connectable: false, draggable: false, position: {x: 100, y: 300}, data: {label: 'bar'}},
    {id: '7', hidden: true, connectable: false, draggable: false, position: {x: 300, y: 300}, data: {label: 'xxx'}},
];
